...
final class Source extends \Dfe\Stripe\W\Event {
	 ...
	 * 2017-11-08
	 * Note 1.
	 * Stripe really sends 2 `source.chargeable` events for each payment
	 * in the 3D Secure verification scenario:
	 ...
	 * 2) The first `source.chargeable` event is for a derived single-use 3D Secure source:
