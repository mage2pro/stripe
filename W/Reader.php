...
final class Reader extends \Df\Payment\W\Reader\Json {
	 ...
	 * Но реально этот ключ присутствует в запросе, и так было всегда с момента разработки модуля (март 2016).
	 * 2017-02-14 [Stripe] An example of the «charge.captured» event (being sent to a webhook) https://mage2.pro/t/2745
	 * @override
	 * @see \Df\Payment\W\Reader::kt()
	 * @used-by \Df\Payment\W\Reader::tRaw()
	 */
	protected function kt():string {return 'type';}
}